...
<head>
    ...
    <style>
        * { 
        ...
        .page-header, .tabs, .jadwal-card, .form-container, .empty-state, .alert { background: var(--surface-card); border-color: var(--border-soft); }
        .page-header h2, label, .hari, .info-value { color: var(--text-main); }
        .page-header p, .info-label, .guru-name, .info-text { color: var(--text-muted); }
        input, select, textarea { background: rgba(255,253,245,0.9); border-color: rgba(102,126,234,0.2); color: #2d3748; }
        input:focus, select:focus, textarea:focus { border-color: #667eea; box-shadow: 0 0 20px rgba(102,126,234,0.2); background: rgba(255,253,245,0.95); }
        body.dark-mode .page-header, body.dark-mode .tabs, body.dark-mode .jadwal-card, body.dark-mode .form-container, body.dark-mode .empty-state, body.dark-mode .alert, body.dark-mode .jadwal-info, body.dark-mode .status-badge { background: rgba(17,24,39,0.9); }
        body.dark-mode input, body.dark-mode select, body.dark-mode textarea { background: rgba(15,23,42,0.75); color: #e5e7eb; }
    ...
    <div class="header">
        <div class="brand-left">
            ...
            <a href="halaman utama.php">
                <h1><i class='bx bx-calendar'></i> Kelola Jadwal</h1>
            </a>
        </div>
